<?php
	...
	$btn_guardar_profesor=new Boton("btn_modificar_profesor","Borrar","borrar_profesor()","75px",true);
...
?>
<form id="frm_abrir_profesor" name="frm_abrir_profesor" action="../profesores/acc_profesor.php" method="post">
