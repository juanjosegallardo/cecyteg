<?php
    ...
    $btn_guardar_usuario=new Boton("btn_guardar_usuario","Guardar","modificar_usuario()","75px",true);
...
?>
<form id="frm_modificar_usuario" name="frm_modificar_usuario" action="../usuarios/acc_usuario.php" method="post">
