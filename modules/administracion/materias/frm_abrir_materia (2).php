<?php
    ...
    $btn_guardar_materia=new Boton("btn_modificar_materia","Borrar","borrar_materia()","75px",true);
...
?>
<form id="frm_abrir_materia" name="frm_abrir_materia" action="../materias/acc_materia.php" method="post">
