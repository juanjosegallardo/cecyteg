    ...
    <tr>
    	<td align="right">
            ...
            <input type="button" id="btn_foto_alumno" value="Foto" class="boton" onclick="cargar_registro('../alumnos/frm_foto_alumno.php', 'id_alumno', 'rad_alumno','div_alumno','frm_foto_alumno');" />
			 <input type="button" id="btn_reporte_alumno" value="Reportes" class="boton" onclick="cargar_registro('../alumnos/frm_reporte_alumno.php', 'id_alumno', 'rad_alumno','div_alumno','frm_reporte_alumno');" />           
	   </td>
    </tr>
</table>
<br />
