<?php
	...
	$btn_guardar_alumno=new Boton("btn_guardar_alumno","Guardar","guardar_alumno()","75px",true);
            
    $obj_formulario = new Formulario();
    $obj_formulario->pantalla = $pantalla_alumno;    
?>
<form id="frm_nuevo_alumno" name="frm_nuevo_alumno" action="../alumnos/acc_alumno.php" method="post">
