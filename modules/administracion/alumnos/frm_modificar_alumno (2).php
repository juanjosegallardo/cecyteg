<?php
    ...
    $btn_guardar_alumno=new Boton("btn_guardar_alumno","Guardar","modificar_alumno()","75px",true);
...
?>
<form id="frm_modificar_alumno" name="frm_modificar_alumno" action="../alumnos/acc_alumno.php" method="post">
