...
if(is_array($obj_session->menu["administracion"]["submenu"]))
{
    foreach( $obj_session->menu["administracion"]["submenu"] as $submenu)
    {    
...
<!-- Inicio Cabecera -->
<?php if(is_array($obj_session->menu["administracion"]["submenu"])):foreach( $obj_session->menu["administracion"]["submenu"] as $submenu): ?>
