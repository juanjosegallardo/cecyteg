<?php
    ...
    $btn_guardar_inventario=new Boton("btn_guardar_inventario","Guardar","modificar_inventario()","75px",true);
...
?>
<form id="frm_modificar_inventario" name="frm_modificar_inventario" action="../inventario/acc_inventario.php" method="post">
