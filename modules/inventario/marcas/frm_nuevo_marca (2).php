<?php
	...
	$btn_guardar_marca=new Boton("btn_guardar_marca","Guardar","guardar_marca()","75px",true);
            
    $obj_formulario = new Formulario();
    $obj_formulario->pantalla = $pantalla_marca;    
?>
<form id="frm_nuevo_marca" name="frm_nuevo_marca" action="../marcas/acc_marca.php" method="post">
