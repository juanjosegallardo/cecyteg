<?php
    ...
    $btn_guardar_marca=new Boton("btn_guardar_marca","Guardar","modificar_marca()","75px",true);
...
?>
<form id="frm_modificar_marca" name="frm_modificar_marca" action="../marcas/acc_marca.php" method="post">
