<?php
    ...
    $btn_guardar_equipo=new Boton("btn_guardar_equipo","Guardar","modificar_equipo()","75px",true);
...
?>
<form id="frm_modificar_equipo" name="frm_modificar_equipo" action="../equipos/acc_equipo.php" method="post">
