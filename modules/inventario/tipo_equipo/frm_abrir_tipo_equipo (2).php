<?php
    ...
    $btn_guardar_tipo_equipo=new Boton("btn_modificar_tipo_equipo","Borrar","borrar_tipo_equipo()","75px",true);
    ...
    w
?>
<form id="frm_abrir_tipo_equipo" name="frm_abrir_tipo_equipo" action="../tipo_equipo/acc_tipo_equipo.php" method="post">
