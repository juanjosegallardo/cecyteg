<?php
	...
	$btn_guardar_tipo_equipo=new Boton("btn_guardar_tipo_equipo","Guardar","guardar_tipo_equipo()","75px",true);
            
    $obj_formulario = new Formulario();
    $obj_formulario->pantalla = $pantalla_tipo_equipo;    
?>
<form id="frm_nuevo_tipo_equipo" name="frm_nuevo_tipo_equipo" action="../tipo_equipo/acc_tipo_equipo.php" method="post">
