<?php
    ...
    $btn_guardar_ubicacion=new Boton("btn_modificar_ubicacion","Borrar","borrar_ubicacion()","75px",true);
...
?>
<form id="frm_abrir_ubicacion" name="frm_abrir_ubicacion" action="../ubicaciones/acc_ubicacion.php" method="post">
