...
if(is_array($obj_session->menu["inventario"]["submenu"]))
{
    foreach( $obj_session->menu["inventario"]["submenu"] as $submenu)
    {    
...
<!-- Inicio Cabecera -->
<?php if(is_array($obj_session->menu["inventario"]["submenu"])):foreach( $obj_session->menu["inventario"]["submenu"] as $submenu): ?>
