<?php
    ...
    $btn_guardar_practica=new Boton("btn_guardar_practica","Guardar","modificar_practica()","75px",true);
...
?>
<form id="frm_modificar_practica" name="frm_modificar_practica" action="../practicas/acc_practica.php" method="post">
