...
if(is_array($obj_session->menu["registro"]["submenu"]))
{
    foreach( $obj_session->menu["registro"]["submenu"] as $submenu)
    {    
...
<!-- Inicio Cabecera -->
<?php if(is_array($obj_session->menu["registro"]["submenu"])):foreach( $obj_session->menu["registro"]["submenu"] as $submenu): ?>
