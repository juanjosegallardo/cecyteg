...
if(is_array($obj_session->menu["opciones"]["submenu"]))
{
    foreach( $obj_session->menu["opciones"]["submenu"] as $submenu)
    {    
...
<!-- Inicio Cabecera -->
<?php if(is_array($obj_session->menu["opciones"]["submenu"])):foreach( $obj_session->menu["opciones"]["submenu"] as $submenu): ?>
